        ...
        <div className="container about" id="about">
            ...
            <div className="col-lg-4 align-self-center">
                ...
                <div className="col-lg-8">
                    ...
                    <p className="mb-4">After 15 years of working in Education and Children's Services, I decided I wanted a better work/life balance and my journey into web development began. I began coding through lockdown in 2020, taking on freelance projects for small businesses and in early 2022 my wife (a dev of 9+ years) and I started our own small business, <a href="https://www.mxcode.co.uk" target="blank">MXCode</a>. We are  a contract-based web development agency based in Haywards Heath working with clients across the UK, Ireland and America. In 2022 I made the decision to join the <a href="https://io-academy.uk/courses/full-stack-track/" target="blank">iO Academy Full-Stack Track</a> in July 2022, giving me the opportunity to build on my knowledge and expand my coding base. I also completed my Scrum Master training as part of the course. </p>
